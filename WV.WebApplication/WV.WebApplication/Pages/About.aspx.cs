...
namespace WV.WebApplication.Pages
{
    public partial class About : PageBase
    {
        ...
        protected void DeleteActivities()
        {
            ...
            var actividades = _actividad.Where(act => act.Programa.TipoPrograma.TipoPrograma1 == "Primera Infancia" && (act.ID_Actividad & 1) != 0);

           // var beneficiariosEducacion = _actividad.Where(ben => ben.Programa.TipoPrograma.TipoPrograma1 == "CIC");


            foreach (var actividad in actividades)
            {

                _actividad.Delete(actividad);
        ...
        protected void ModifyActivities()
        {
            IDataRepository<Actividad> _actividad;
            ...
            string[] actividadesDesc = new string[18];
            actividadesDesc[0] = "Inicio, Registro de Participantes";
            actividadesDesc[1] = "Refuerzo Matemática Parte 1";
            actividadesDesc[2] = "Refuerzo Matemática Parte 2";
            actividadesDesc[3] = "Refuerzo Matemática Parte 3";
            actividadesDesc[4] = "Refuerzo Matemática Parte 4";
            actividadesDesc[5] = "Evaluación Matematica 1";
            actividadesDesc[6] = "Refuerzo Lenguaje y Literatura 1";
            actividadesDesc[7] = "Refuerzo Lenguaje y Literatura 2";
            actividadesDesc[8] = "Refuerzo Lenguaje y Literatura 3";
            actividadesDesc[9] = "Refuerzo Lenguaje y Literatura 4";
            actividadesDesc[10] = "Evaluación L y L 1";
            actividadesDesc[11] = "Refuerzo Ciencias Naturales 1";
            actividadesDesc[12] = "Refuerzo Ciencias Naturales 2";
            actividadesDesc[13] = "Evaluación Ciencias Naturales 1";
            actividadesDesc[14] = "Refuerzo Ciencias Sociales 1";
            actividadesDesc[15] = "Refuerzo Ciencias Sociales 2";
            actividadesDesc[16] = "Evaluación Ciencias Sociales 1";
            actividadesDesc[17] = "Convivencia Intercomunitaria";
             
            var actividades = _actividad.Where(act => act.Programa.TipoPrograma.TipoPrograma1 == "CIC");
            ...
            foreach (var actividad in actividades)
            {
                ...
                if (actividad.ID_Programa == 34)
                {
                    actividad.ActividadDescripcion = actividadesDesc[counter];
                    if (counter  == 17 )
                    {
                        counter = -1;
                    }
                }
                else if (actividad.ID_Programa == 35)
                {
                    actividad.ActividadDescripcion = actividadesDesc[counter];
                    if (counter == 17)
                    {
                ...
                else if (actividad.ID_Programa == 36)
                {
                    actividad.ActividadDescripcion = actividadesDesc[counter];
                    if (counter == 17)
                    {
                ...
                else if (actividad.ID_Programa == 37)
                {
                    actividad.ActividadDescripcion = actividadesDesc[counter];
                    if (counter == 17)
                    {
        ...
        protected void GenerateSchoolarData()
        {
            string[] CentrosEscolares = new string[4];
            CentrosEscolares[0] = "Lote #";
            CentrosEscolares[1] = "Casa #";
            CentrosEscolares[2] = "Lotificación #";
            CentrosEscolares[3] = "";
            ...
            var beneficiariosEducacion = _beneficiario.Where(ben=>ben.Programa.TipoPrograma.TipoPrograma1 == "CIC");


            foreach (var beneficiario in beneficiariosEducacion)
            {
                if (beneficiario.Programa.ID_Comunidad == 14)
                {
                    beneficiario.BeneficiarioEducacion.First().NombreCentroEscolar = CentrosEscolares[0];
                }
                else if (beneficiario.Programa.ID_Comunidad == 15)
                {
                    beneficiario.BeneficiarioEducacion.First().NombreCentroEscolar = CentrosEscolares[1];
                }
                else if (beneficiario.Programa.ID_Comunidad == 1020)
                {
                    beneficiario.BeneficiarioEducacion.First().NombreCentroEscolar = CentrosEscolares[2];
                }
                else if (beneficiario.Programa.ID_Comunidad == 1021)
                {
                    beneficiario.BeneficiarioEducacion.First().NombreCentroEscolar = CentrosEscolares[3];
                }
        ...
        protected void GenerateAddreses()
        {
            string[] Cantones = new string[22];
            Cantones[0] = "CASERIO EL CENTRO";
            Cantones[1] = "FINAL BARRIO SAN JOSE SALIDA A CANTON TEOSINTE";
            Cantones[2] = "BARRIO EL CENTRO SALIDA A SAN BARTOLO ";
            Cantones[3] = "PASAJE COLONIA SANTA CRISTINA";
            Cantones[4] = "CALLE QUE DE JUJUTLA CONDUCE HACIA EL PEÑON";
            Cantones[5] = "CALLE PRINCIPAL A CASERIO CASHAGUA ";
            Cantones[6] = "CALLE QUE DE JUJUTLA CONDUCE AL PEÑON";
            Cantones[7] = "CALLE PRINCIPAL AL PEÑON";
            Cantones[8] = "DOS KILOMETROS CARRETERA A SAN PEDRO PUXTLA";
            Cantones[9] = "CALLE QUE DE GUAYMANGO CONDUCE AL ZUNZA";
            Cantones[10] = "CANTON EL ZARZAL CASERIO LOS ASCENCIO";
            Cantones[11] = "CALLE PRINCIPAL AL CANTON";
            Cantones[12] = "CASERIO EL CAMELOTES";
            Cantones[13] = "CASERIO SANTA ELENA";
            Cantones[14] = "CASERIO LOS GUARDADOS";
            Cantones[15] = "CALLE LITORAL CON DESVIO DEL PEÑON";
            Cantones[16] = "CANTON EL ROSARIO HACIENDA CALIFORNIA";
            Cantones[17] = "KILOMETRO DOS Y MEDIO CARRETERA DE JUJUTLA";
            Cantones[18] = "DOS CUADRAS AL SUR DEL EX ORATORIO CATOLICO";
            Cantones[19] = "DESVIO CENTRO ESCOLAR";
            

            string[] housetype = new string[4];
            housetype[0] = "Lot # ";
            housetype[1] = "Casa # ";
            housetype[2] = "Lotificación # ";
            housetype[3] = "# ";
            ...
            var beneficiariosEducacion = _beneficiario.GetAll();
            ...
            foreach (var beneficiario in beneficiariosEducacion)
            {
                if (beneficiario.Programa.ID_Comunidad == 14)
                {
                    ...
                    int canton = rand.Next(0,5);

                    int houseNumber = rand.Next(50);

                    int houseType = rand.Next(housetype.Length);

                    beneficiario.Direccion = Cantones[canton] +" "+ housetype[houseType]+ houseNumber +", "+ beneficiario.Programa.Comunidad.Comunidad1;
                }
                else if (beneficiario.Programa.ID_Comunidad == 15)
                {
                    Random rand = new Random();

                    int canton = rand.Next(5, 10);
